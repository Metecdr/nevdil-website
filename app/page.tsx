    ...
    <>
      ...
      <section className="relative bg-black overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-24 pb-28 text-center">
          <span className="inline-block bg-yellow-400 text-black text-xs font-black px-4 py-1.5 rounded-full uppercase tracking-widest mb-8 animate-fade-in-up">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-12 animate-fade-in-up delay-200">
      ...
      <section className="bg-black py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mt-3">Ön Kayıt</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {onkayitlar.map((k) => (
              <div
                key={k.id}
                className="bg-gray-950 border border-yellow-400/25 rounded-2xl p-8 hover:border-yellow-400/60 transition-all hover:-translate-y-1 group flex flex-col"
              >
      ...
      <section className="bg-gray-950 py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mt-3">Kurs Seviyeleri</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {courses.map((c) => (
              <div
                key={c.level}
                className="bg-black border border-gray-800 rounded-2xl p-8 hover:border-yellow-400/50 transition-all group"
              >
      ...
      <section className="bg-black py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mt-3">Kursumuzdan Kareler</h2>
      ...
      <section className="bg-yellow-400 py-24">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-black mb-5">
